...
export const MOCK_EMPLOYEES: Employee[] = [
  {
    ...
    salary: { basic: 1000, housing: 0, transport: 0, other: 200 }, active: true, bankName: 'Abu Dhabi Commercial Bank', iban: 'AEXXXXXXXXXXXXX'
  },
  {
    ...
    status: 'Active', team: 'Internal Team', workLocation: '-', leaveBalance: 30,
    salary: { basic: 1500, housing: 0, transport: 0, other: 1000 }, active: true, bankName: 'Emirates NBD', iban: 'AEXXXXXXXXXXXXX'
  },
  {
    ...
    status: 'Active', team: 'Internal Team', workLocation: '-', leaveBalance: 30,
    salary: { basic: 1500, housing: 0, transport: 0, other: 300 }, active: true, bankName: 'Commercial Bank of Dubai', iban: 'AEXXXXXXXXXXXXX'
  },
  {
    ...
    status: 'Active', team: 'Internal Team', workLocation: '-', leaveBalance: 30,
    salary: { basic: 1500, housing: 0, transport: 0, other: 300 }, active: true, bankName: 'First Abu Dhabi Bank', iban: 'AEXXXXXXXXXXXXX'
  },
  {
    ...
    status: 'Active', team: 'Internal Team', workLocation: '-', leaveBalance: 30,
    salary: { basic: 1000, housing: 0, transport: 0, other: 800 }, active: true, bankName: 'Cash', iban: ''
  },
  {
    ...
    status: 'Active', team: 'Internal Team', workLocation: '-', leaveBalance: 30,
    salary: { basic: 1000, housing: 0, transport: 0, other: 250 }, active: true, bankName: 'Cash', iban: ''
  },
  {
    ...
    salary: { basic: 800, housing: 0, transport: 0, other: 200 }, active: true, bankName: 'Cash', iban: ''
  },
  {
    ...
    salary: { basic: 1000, housing: 0, transport: 0, other: 200 }, active: true, bankName: 'Cash', iban: ''
  },
  {
    ...
    status: 'Active', team: 'Internal Team', workLocation: '-', leaveBalance: 30,
    salary: { basic: 1500, housing: 0, transport: 0, other: 300 }, active: true, bankName: 'Cash', iban: ''
  },
  {
    ...
    salary: { basic: 4500, housing: 0, transport: 0, other: 0 }, active: true, bankName: 'Abu Dhabi Commercial Bank', iban: 'AEXXXXXXXXXXXXX'
  },
  {
  ...
  },
  {
    ...
    status: 'Active', team: 'Internal Team', workLocation: 'Head Office, Abu Dhabi', leaveBalance: 30,
    salary: { basic: 1000, housing: 0, transport: 0, other: 500 }, active: true, bankName: 'Cash', iban: ''
  },
  {
